...
public class MyAndroidDriver implements DriverSource {
    ...
    public AndroidDriver newDriver() {
        ...
        capabilities.setCapability("appPackage", "com.realiseme.uat");
        capabilities.setCapability("appActivity", "com.realiseme.MainActivity");
        try {
    ...
    public static AndroidElement getElementByXpath(String xpath) throws Exception {
        for (int i = 0; i < 10; i++) {
            try {
                return (AndroidElement) driver.findElementByXPath(xpath);
